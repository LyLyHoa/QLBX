...
Public Class Ban_ve
    ...
    Public Sub Update_Ve_xe()
        ...
        Clear_Controls()
    End Sub
    Public Sub Loc_Ve_xe(ByVal strLoc As String)
        Doc_tuyen_xe()
        doc_bang_theo_chuoi(strLoc)
        Clear_Controls()
    End Sub
    ...
    End Sub
    Private Sub doc_bang_theo_chuoi(ByVal strLoc As String)
        lenh = "Select IdVe, TenHanhKhach, SDTHanhKhach, TenTuyen, NgayDi, Gio, So_Xe from BanVe, ChuyenXe, TuyenXe "
        lenh &= " where BanVe.IdChuyen = ChuyenXe.IdChuyen and ChuyenXe.IdTuyen = TuyenXe.IdTuyen and (TenHanhKhach like '%" + strLoc + "%'" + " or TenTuyen like '%" + strLoc + "%')"
        bang_dat_ve = Doc_bang(lenh)
        With Form_Main.cbo_MaSoVe
            .DataSource = bang_dat_ve
            .ValueMember = "IdVe"
